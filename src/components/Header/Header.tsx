...
export const Header = () => {
  return (
    <div className="flex flex-row items-center justify-between bg-white h-24">
      <img src="connect2.png" alt="logo" className="w-14 h-14" />
      <div className="flex flex-row items-center w-full justify-end space-x-1">
        <input
          type="text"
