...
export const CalendarView = () => {
  return (
    <div className="bg-white dark:bg-gray-800 flex flex-grow items-start justify-start">
      <div className="h-full w-[285px] md:w-[276px] md:h-[682px] lg:h-full lg:w-[350px] shadow-xl bg-gray-100 dark:bg-gray-900">
        <CalendarFeature />
      </div>
      <div className="lg:flex flex-col items-center justify-center hidden lg:ml-[600px] lg:mt-[200px] space-y-4">
